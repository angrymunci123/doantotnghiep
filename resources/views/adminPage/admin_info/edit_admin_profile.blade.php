                ...
                <div class="col-lg-12 grid-margin stretch-card">
                            <div class="container-fluid" style="width: 1500px; background-color: white">
                                <div class="card-body">
                                    ...
                                    <form action="/admin/admin_info/update_profile/admin_id={{$admin_info->user_id}}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div hidden class="form-group">
                                            ...
                                            <input type="text" name="position" class="form-control" id="" value="{{$admin_info->position}}">
                                        </div>
                                        <br>
                                        <div>
