                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-lg-4 bg-grey">
                                <div class="p-5">
                                    ...
                                    <h5 class="text-uppercase mb-3">Recipient's full name</h5>

                                    <div class="mb-5">
                                        <div class="form-outline">
                                            <input type="text" id="form3Examplea2" class="form-control form-control-lg" />
                                            <label class="form-label" for="form3Examplea2">Enter recipient's full name</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-5">
                                        <div class="form-outline">
                                            <input type="text" id="form3Examplea2" class="form-control form-control-lg" />
                                            <label class="form-label" for="form3Examplea2">Enter your email</label>
                                        </div>
                                    </div>
