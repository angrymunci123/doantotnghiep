...
<head>
    ...
    <title>Shoes Street - Adidas</title>
</head>
<body>
<div style="background-color: #F9F9F9">
    <div class="container-fluid page-header">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Adidas</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item text-white active" aria-current="page">Adidas</li>
                </ol>
            </nav>
        </div>
    </div>
