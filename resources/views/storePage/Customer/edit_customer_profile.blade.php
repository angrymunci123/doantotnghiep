                        ...
                        <div class="card-group">
                            <div class="container-fluid" style="width: 1500px; background-color: white">
                                ...
                                <div class="card-body table-responsive pt-3">
                                    <form action="/storeIndex/customer_profile/edit_customer_profile/process/{{$obj->customer_id}}" method="post" enctype="multipart/form-data">
                                        @csrf
...
{{--                                            <input type="password" name="confirm_new_password" class="form-control" id="" placeholder="Confirm Password">--}}
{{--                                        </div>--}}
{{--                                        <br>--}}
                                        <div>
